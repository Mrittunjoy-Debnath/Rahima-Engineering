...
@section('content')
    ...
    <div class="page-title-section section section-padding-top" data-overlay="0.7" data-bg-image="{{asset('fontend')}}/assets/images/bg/breadcrumb-bg-four.jpg">
...
{{--                            <div class="thumbnail">--}}
{{--                                <a href="blog-details.html" class="image"><img class="w-100" src="{{asset('fontend')}}/assets/images/blog/770/blog-1.jpg" alt="Blog Image"></a>--}}
{{--                            </div>--}}
{{--                            <div class="info">--}}
{{--                                <ul class="meta">--}}
...
{{--                        <div class="blog-3 col" data-aos="fade-up">--}}
{{--                            <div class="thumbnail">--}}
{{--                                <a href="blog-details.html" class="image"><img class="w-100" src="{{asset('fontend')}}/assets/images/blog/770/blog-3.jpg" alt="Blog Image"></a>--}}
{{--                            </div>--}}
{{--                            <div class="info">--}}
{{--                                <ul class="meta">--}}
{{--                                    <li><i class="fal fa-pencil-alt"></i>Written by Admin, 10 Oct 2020</li>--}}
...
{{--                                    <li><i class="fas fa-comments"></i>4 Comments</li>--}}
{{--                                </ul>--}}
{{--                                <h3 class="title"><a href="blog-details.html">Google rebrands G Suite to Workspace to bring Gmail, Docs, and Meet together</a></h3>--}}
{{--                                <div class="desc">--}}
{{--                                    <p>G Suite is no more. The Big G is rebranding the office service to Google Workspace in an effort to bring Gmail, Calendar, Drive, Docs, Sheets, Slides, Meet, and more all in the same spot. The new Workspace should already be available to all paying customers.</p>--}}
{{--                                </div>--}}
{{--                                <a href="blog-details.html" class="btn btn-primary btn-hover-secondary mt-6">Read More</a>--}}
{{--                            </div>--}}
{{--                        </div>--}}
