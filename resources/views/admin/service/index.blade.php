            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="text-center font-1">Service Info</h3>
                                ...
                                @foreach ($services as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('admin.services.show',$row->id)}}" class="btn btn-info waves-effect">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.services.edit',$row->id) }}" class="btn btn-success waves-effect">
