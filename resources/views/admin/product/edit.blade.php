            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="{{ route('admin.products.update',$category->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="editor" class="form-control" name="short_description" rows="4" placeholder=" Short Description">{{ $category->short_description }}</textarea>
...
{{--                                    <textarea  class="form-control" name="price" rows="4" placeholder=" Price">{{ $category->price }}</textarea>--}}
