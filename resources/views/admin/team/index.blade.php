                                ...
                                @foreach ($news as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('admin.teams.show',$row->id)}}" class="btn btn-info waves-effect">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.teams.edit',$row->id) }}" class="btn btn-success waves-effect">
                                            ...
                                            <form id="delete-form-{{ $row->id }}" action="{{ route('admin.teams.destroy',$row->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
