            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="text-center font-1">Category Info</h3>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tr>
                                    <th>Long Desc</th><td>{{ $category->link }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>Action</th><td class="text-center">
                                        <a href="{{ route('admin.category.show',$category->id) }}" class="btn btn-info waves-effect">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.category.edit',$category->id) }}" class="btn btn-success waves-effect">
